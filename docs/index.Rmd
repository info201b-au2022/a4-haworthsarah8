...
plot_jail_pop_for_us <- function()  {
  plot_jail <- ggplot(data = get_year_jail_pop(), aes(y = total_jail_pop, x = year)) +
    ...
    labs(title = "Increase of Jail Population in U.S. (1970-2018).", caption = "Figure 1. Increase of Jail Population in U.S. (1970-2018). 
...
plot_jail_pop_by_states <- function(states) {
  plot_state_jail <- ggplot(data = get_jail_pop_by_states(states), aes(x = year, y = total_jail_pop, group = state, color = state)) +
    geom_line() +
